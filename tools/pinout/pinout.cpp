...
int main() {
...

	{
		...
		vector<db::Pinset> psets; // mocking pinset updates, they're not yet generated by this application
		db::savePinsets(db, psets);

		db::linkOrderableToPinset(db, ordbls); // not a mock, but nothing has changed so right now it's useless
