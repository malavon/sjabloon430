...
int main() {
	// layout idea try, 2 "columns" with top header or something
	// left column fill in, more columns
	// packages/pins        signal (fill)       signal group|explanation

	// right column
	// several groups of devices, filters, F1 - etc

	// then bottom: buttons or something?
	...
	// 		hbox({
	// 			text("Datasheet ") | bold,
	// 			text("SLASXY") | color(Color::Blue)}),
	// 		vbox({
	// 			hbox({
	// 				text("Drawings ") | bold,
	// 				text("N20 PW20 PW28") | color(Color::Cyan),
	// 				input
	// 			}),
	// 			filler(),
	// 			hbox({
